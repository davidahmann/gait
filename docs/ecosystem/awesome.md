...
- LangChain (official middleware lane): `examples/integrations/langchain/`
- OpenAI Agents reference boundary demo: `examples/integrations/openai_agents/`
- AutoGen reference adapter: `examples/integrations/autogen/`
- OpenClaw reference adapter: `examples/integrations/openclaw/`
- OpenClaw installable skill package: `examples/integrations/openclaw/skill/`
- AutoGPT reference adapter: `examples/integrations/autogpt/`
- Gas Town reference adapter: `examples/integrations/gastown/`
