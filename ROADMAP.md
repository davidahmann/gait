...
A separate repo and installable skill set that teaches agents how to use the Gait CLI correctly, safely, and deterministically.
...
These map exactly to your v1 ladder and do not expand scope.
